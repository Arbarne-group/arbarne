...
const DEFAULT_USER: User = {
  ...
  farm_region: 'Nairobi Region, Kenya',
  farm_crop_type: 'Maize, Soybeans, Avocados',
  farm_size_acres: 296.5,
  total_size_hectares: 120,
  farm_registration_number: 'REG-2023-8849',
  ...
  soil_type: 'Clay Loam',
  water_source: 'Borehole & Rain',
  workforce: '15 Permanent',
  energy: 'Solar Grid',
  verified: true,
  tier: 2,
  tier_name: 'Emerging Agribusiness',
  ffmi_score: 72,
  overall_score: 72,
  percentile_rank: 'Top 15% in region',
  strongest_areas: [
    { title: 'Smart Farming & Tech', description: 'Advanced irrigation deployment.' },
    { title: 'Food Safety', description: 'Consistent compliance records.' },
  ],
  requires_attention: [
    { title: 'Energy & Reliability', description: 'High reliance on diesel generators.' },
    { title: 'Financial Documentation', description: 'Incomplete yield records for Q3.' },
  ],
};
