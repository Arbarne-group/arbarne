          ...
          {services.map((s) => (
            ...
            >
              <div className="space-y-3">
                ...
                <div className="text-xs font-semibold text-emerald-800">{s.name}</div>
              ...
              <div className="pt-4 border-t border-slate-100 space-y-3">
                <div className="flex items-center justify-between text-xs">
                  <div className="font-extrabold text-pine-950">
                ...
                <button
                  ...
                  className="w-full py-2.5 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-pine-950 font-bold text-xs shadow-md transition-colors"
                >
