...
if TYPE_CHECKING:
    from app.models.framework import Question, RuleVersion
    from app.models.evidence import Evidence
    from app.models.recommendation import Recommendation


class Farm(Base):
    """A farm record. May be anonymous in the pilot."""
...
class Assessment(Base):
    """A single assessment of a farm. Same question set for self & FFV."""
